...
REDIS_URL = os.getenv("REDIS_URL", "redis://127.0.0.1:6379")  # Default to local Redis if env var is missing
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [REDIS_URL],  # Use environment variable
        },
    }
}
...
DATABASES = {
    'default': {
        ...
        'NAME': 'football_al24',
        'USER': 'root',
        'PASSWORD': 'drini123',  # replace this
        'HOST': '127.0.0.1',
        'PORT': '3306',
        'OPTIONS': {
